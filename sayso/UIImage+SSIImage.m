...
@implementation UIImage (SSIImage)
...
- (UIImage *)imageByScalingProportionallyToSize:(CGSize)targetSize
{
    ...
    // A nice starting point from...
    // http://stackoverflow.com/questions/185652/how-to-scale-a-uiimageview-proportionally
    // However, does not take into account the different idiom resolutions! Shouldn't be much
    // trouble to add this back in, but for now this method is not useful until we get around
    // to that.
